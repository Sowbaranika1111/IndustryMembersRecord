    ...
    useEffect(() => {
        const fetchBatchmateData = async () => {
            try {
                ...
                console.log('PLM Testing data:', {
                    plm_testing: response.data.data.plm_testing,
                    plm_testing_expertise: response.data.data.plm_testing_expertise,
                    plm_testing_experience: response.data.data.plm_testing_experience
                });
                console.log('PLM Support data:', {
                    plm_support: response.data.data.plm_support,
                    plm_support_expertise: response.data.data.plm_support_expertise,
                    plm_support_experience: response.data.data.plm_support_experience
                });
                console.log('PLM Integration data:', {
                    plm_interfaceintegration: response.data.data.plm_interfaceintegration,
                    plm_integration_expertise: response.data.data.plm_integration_expertise,
                    plm_integration_experience: response.data.data.plm_integration_experience
                });
                const initialData = transformDataForFrontend(response.data.data);
                console.log('Transformed form data:', initialData);
                console.log('Transformed PLM fields:', {
                    plm_testing: initialData.plm_testing,
                    plm_testing_expertise: initialData.plm_testing_expertise,
                    plm_testing_experience: initialData.plm_testing_experience,
                    plm_support: initialData.plm_support,
                    plm_support_expertise: initialData.plm_support_expertise,
                    plm_support_experience: initialData.plm_support_experience,
                    plm_interfaceintegration: initialData.plm_interfaceintegration,
                    plm_integration_expertise: initialData.plm_integration_expertise,
                    plm_integration_experience: initialData.plm_integration_experience
                });
